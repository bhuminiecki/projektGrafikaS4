...
float boneVertices[]={
			...
			float boneVertexNormals[]={
				//Wall 1
				0.0f,-0.025f,-0.025f,0.0f,
				-1.0f, 0.025f,-0.025f,0.0f,
				-1.0f,-0.025f,-0.025f,0.0f,
...
glm::mat4 drawBone(ShaderProgram *sp, glm::vec3 translation, float rotation[3], glm::mat4 M, GLuint tex0, GLuint spec0)
{
